...
<body>
<div class="content"><div class="header"><?PHP echo $mode; ?><span class="balance"><?PHP echo substr($bittrexBalance, 0, 6); ?> btc ($ <?php echo floor($bitcoinPrice * $bittrexBalance); ?>)</span></div>
<div class="header">
</div>
<div class="menu">
